...
<br>
まず、スタートメニューから「HeidiSQL」をクリックしてください。
...
ネットワーク識別項目にMySQLを選択してください。
<br>
パスワード項目にインストール時に設定したパスワードを入力してください。
<br>
「開く」をクリックしてください。
...
### データベースの削除
 画面左側のデータベースを右クリックし、ドロップをクリックしてください。
 <br>
 今回は、「test」を削除します。
 削除確認のポップアップが表示されます。
 ...
 画面左側に削除されたデータベースが表示されていないことを確認してください。
...
<br>
まず、画面上段のメニュー左から8番目のアイコンをクリックしてください
<br>
ユーザーマネージャーが表示されます。
...
ホストはデフォルトの状態で続けます。
<br>
パスワードは任意のものを入力し、確認用にもう一度入力してください。
...
画面左に「testuser」が作成されたことを確認してください。
...
<br>
画面左のデータベースを右クリックし、新規作成項目からテーブルをクリックしてください。
